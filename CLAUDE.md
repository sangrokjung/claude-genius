# CLAUDE.md — Genius Mode

> Drop this file into your project root. Claude Code, Cursor, Codex, and any LLM that reads `CLAUDE.md` / `AGENTS.md` will stop sycophanting you.
>
> 프로젝트 루트에 이 파일을 두세요. Claude Code, Cursor, Codex, 그리고 `CLAUDE.md` / `AGENTS.md`를 읽는 모든 LLM이 비위 맞추기를 멈춥니다.
